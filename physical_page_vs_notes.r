...
#NOTE -- this is *not* optimized code -- everything should be done in one go, with no repetitions and no comment on/off switch
...
#MISLEADING VIZ
barplot(c(recto_per, verso_per),
        main = "Percentage of notes from Recto and Verso pages\n(physical books)\n(misleading)",
        names.arg = c("Recto", "Verso"),
        ylab = "Percentage", ylim = c(40,60), xpd = FALSE)
